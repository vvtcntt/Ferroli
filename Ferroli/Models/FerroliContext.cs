...
using Ferroli.Models.Mapping;

namespace Ferroli.Models
{
    public partial class FerroliContext : DbContext
    {
        static FerroliContext()
        {
            Database.SetInitializer<FerroliContext>(null);
        }

        public FerroliContext()
            : base("Name=FerroliContext")
        {
        }
